...
const ProductChat = ({ productName, productCount }) => {
    return (
        ...
        >
            ...
            <Text ml={2} fontSize="12px" color="gray.700" mb={20}>
                14:48
            </Text>
        </VStack>
    );
